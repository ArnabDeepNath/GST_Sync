...
class _ItemListPageState extends State<ItemListPage> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      itemBloc.stream.listen((state) {
        if (state is ItemsLoaded) {
          print('Items loaded: ${state.items.length}');
  ...
  void _loadItems() {
    ...
    if (selectedStore != null) {
      print('Loading items for store: ${selectedStore.id}');
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Dismissible(
                          ...
                          confirmDismiss: (direction) async {
                            // Don't allow dismiss when in multi-select mode
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text('UQC: ${UQCCodes.getUQCName(item.uqc)}'),
                                ],
                              ),
