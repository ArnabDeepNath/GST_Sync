        ...
        TextButton(
          onPressed: () {
            if (_formKey.currentState?.validate() ?? false) {
              ...
              // Get tax rate for item saving below
              final taxRate = double.tryParse(_taxRateController.text) ?? 0.0;
              final unitPrice = rate;
              final totalPrice = quantity * unitPrice * (1 + taxRate / 100);
              final taxAmount = quantity * unitPrice * (taxRate / 100);
              ...
              final item = InvoiceItem(
                ...
                invoiceId: '', // This will be set when the invoice is saved
